<template>
  <div class="bg-amber-50 text-gray-900">
    ...
    <div class="inline-flex gap-2">
      <button @click="start" type="button" class="p-2 border border-amber-300">
        Start
      </button>
      <button @click="stop" type="button" class="p-2 border border-amber-300">
        Stop
      </button>
      <button @click="reset" type="button" class="p-2 border border-amber-300">
        Reset
      </button>
    </div>
  </div>
